...
namespace Dashboard.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260424165935_AddKeysAlertsSchedules")]
    partial class AddKeysAlertsSchedules
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dashboard.Core.Entities.AlertIncident", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("RuleId", "State");

                    b.ToTable("alert_incidents", (string)null);
                });

            modelBuilder.Entity("Dashboard.Core.Entities.AlertRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Dashboard.Core.Entities.ApiKey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Dashboard.Core.Entities.ScheduledExecution", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("scheduled_executions", (string)null);
                });
